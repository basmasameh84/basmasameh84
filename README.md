...
<p align="center">
  <img src="https://media.giphy.com/media/3o7abld9k6oN7h7HAs/giphy.gif" width="420" style="border-radius: 15px;"/>
</p>
...
class BasmaAI:
    def __init__(self):
        ...
        self.skills = ["Deep Learning", "Computer Vision", "Data Analysis", "ML Pipelines"]
        self.goals = "Building AI that matters"

    def intro(self):
        return f"Hi, I'm Basma — Turning data into intelligence ✨"
